...
<html>
    <head>
        ...
        <title>Data Pemnatauan Covid-19</title>
        ...
        <div class="container-fluid my-5">
            ...
            <div class="card" style="width: 70rem;">
                ...
                <div class="card-header pt-4">
                    <h5 class="card-title text-center">Data Pemantauan Covid-19</h5>
                    <h5 class="card-title text-center">Per 1 Mei 2021 22.23</h5>
                </div>
